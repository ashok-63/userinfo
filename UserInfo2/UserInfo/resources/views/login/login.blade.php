                ...
                <div class="screen__content">
                    ...
                    <div class="info" style="position: absolute">
                        @if (Session::has('success'))
                            <h6 class="mx-3 my-1" style="color: #000000cc;"> {{ Session::get('success') }}
                            </h6>
                    ...
                    <div class="js-tilt" style="text-align: center"> <img
                            src="{{ url('/public/backend/assets/images/imp/logo.jpg') }}" class="img-responsive"
...
<script src="{{ url('/public/backend/assets/js/tilt.jquery.min.js') }}"></script>
<script>
    $('.js-tilt').tilt({
        scale: 1.1
    })
