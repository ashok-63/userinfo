    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="sendEmailForm" action="javascript:void(0)" method="POST" data-form-url="{{ 'sendEmail' }}">
                    ...
                    <div class="modal-footer">
                        ...
                        {{-- <button type="button" class="btn btn-danger btn-rounded text-left modal_close " data-dismiss="modal" style="border-radius: 4px;">Close</button> --}}
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade send-sms-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg" style="max-width: 500px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="sendSMSForm" action="javascript:void(0)" data-form-url="{{ 'sendSMS'}}" method="POST">
                    <div class="form-group">
                        <span>
                    ...
                    {{-- <div class="form-group">
                        <label for="message-text" class="col-form-label">Select Template:</label>
                        <select name="sms_template" id="sms_template"
                            class="form-control form-control-sm form-select">
                            <optgroup label="R1">
                                <option value="101">NPAV Unlock Code</option>
                                <option value="102">Renewal Reminder</option>
                                <option value="103">NP Mobile Security</option>
                            </optgroup>
                            <optgroup label="R2">
                                <option value="1">Support Numbers</option>
                                <option value="2">Activation Numbers</option>
                                <option value="3">Sms Support Call</option>
                                <option value="7">HDFC IFSC Code</option>
                                <option value="8">SMS Activation</option>
                                <option value="9">React.EXE</option>
                                <option value="10">Sales Numbers</option>
                                <option value="12">NPAV Update Solution</option>
                                <option value="13">NPAV Fast Update Solution</option>
                                <option value="15">NPAV Key Number</option>
                                <option value="16">NPAV Unlock Code</option>
                                <option value="17">NPAV Unlock Code With APK</option>
                                <option value="18">NP Mobile Security</option>
                                <option value="19">NP Setup Download Links</option>
                            </optgroup>
                        </select>
                    </div> --}}
                    <div class="row col-md-12" style="margin-top: 6px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="javascript:void(0)" method="post" id="createNoteForm"
                    data-form-url="{{ 'createNotes' }}">
                    <div class="form-group">
                        {{-- <label for="" class="col-form-label">Cust No</label> --}}
...
{{-- Release Key Model End --}}
{{-- Dealer Act Count Start --}}
...
{{-- District Wise Count Model Start --}}
