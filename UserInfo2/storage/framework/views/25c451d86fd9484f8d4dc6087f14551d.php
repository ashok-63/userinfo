                    ...
                    <div class="modal-dialog w-100 mx-auto">
                        <div class="modal-content">
                            <?php if(session('success')): ?>
                                <span class="text-success mt-2 px-3"><b> <?php echo e(session('success')); ?></b></span>
                            <?php elseif(session('error')): ?>
                                <span class="text-danger mt-2 px-3"><b> <?php echo e(session('error')); ?></b></span>
                            <?php endif; ?>
...
<?php /**PATH C:\inetpub\wwwroot\UserInfo2\resources\views/SendOTP.blade.php ENDPATH**/ ?>