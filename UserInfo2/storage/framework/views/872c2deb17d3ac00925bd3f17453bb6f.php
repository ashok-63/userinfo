...
<?php $__env->startSection('content'); ?>
    ...
    <div class=" mt-2 main_container">
        <div class="row">
            ...
            ?>
            <div class="col-md-12">
                <form method="POST" id="SearchKeyDetails" action="#" data-form-url="<?php echo e('SearchByKey'); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-10">
                            <div class="row">
                                <div class="col-3 selectBoxDiv">
                                    <div class="form-group">
                                        <select class="form-control select2_search_by-" name="search_by" id="search_by">
                                            ...
                                            <?php if($loggedUserName == 'sumeet' || $loggedUserName == 'kanchanb' || $loggedUserName == 'sandeepb'): ?>
                                ...
                                <div class="col-3 inputBoxDiv">
                                    <div class="form-group">
                                        <input type="text" class="form-control search_txt" id="search_txt"
                                            ...
                                            <?php if($keyNo): ?> value="<?php echo e($keyNo); ?>"
                                             <?php else: ?>
                                             value="" <?php endif; ?>
        ...
        <?php echo $__env->make('layouts.navigation-buttons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="hw_modal_body" data-form-url="<?php echo e('FetchHWDetails1'); ?>">
        </div>
    ...
    <script src="<?php echo e(url('/public/backend/assets/js/include/dashboard.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\UserInfo2\resources\views/dashboard.blade.php ENDPATH**/ ?>